...
const firebaseConfig = {
  ...
  authDomain: (import.meta as any).env?.VITE_FIREBASE_AUTH_DOMAIN || "comerciopro-app.firebaseapp.com",
  projectId: (import.meta as any).env?.VITE_FIREBASE_PROJECT_ID || "comerciopro-app",
  storageBucket: (import.meta as any).env?.VITE_FIREBASE_STORAGE_BUCKET || "comerciopro-app.appspot.com",
