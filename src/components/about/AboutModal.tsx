        ...
        <div className="p-6 space-y-5 text-slate-700 max-h-[75vh] overflow-y-auto">
          ...
          <div className="bg-slate-50 rounded-xl p-4 border border-slate-200/70 text-xs text-slate-600 leading-relaxed">
            <p className="flex items-start space-x-2">
              ...
              <span>
                <strong>ComercioPro</strong> es una solución de gestión comercial modular multirubro diseñada para optimizar negocios de mostrador mediante control de inventario con doble anclaje (USD/Bs), punto de venta offline-first y registro de fiados.
              </span>
            </p>
          </div>
