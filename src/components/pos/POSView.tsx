...
export const POSView: React.FC = () => {
  ...
  // Filtered categories (dynamic from inventory + products)
        ...
        <div className="p-4 border-t border-slate-200 bg-slate-50 space-y-3">
          ...
          <button
            ...
            className={`w-full py-3.5 rounded-xl font-black text-base shadow-lg transition flex items-center justify-center space-x-2 ${
              cart.length > 0
                ? 'bg-amber-500 hover:bg-amber-400 active:bg-amber-600 text-slate-950 shadow-amber-500/25 active:scale-[0.98]'
        ...
        <div className="md:hidden fixed bottom-16 left-0 right-0 px-3.5 py-2.5 bg-brand-slate-900/95 backdrop-blur-md text-white z-30 shadow-2xl border-t border-slate-800 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2 shrink-0">
            ...
            <button
              type="button"
              onClick={() => setIsCheckoutOpen(true)}
              className="px-4 py-2 bg-amber-500 hover:bg-amber-400 text-slate-950 font-black text-sm rounded-xl shadow-md active:scale-95 transition flex items-center space-x-1.5"
            >
              ...
              <div className="p-4 border-t border-slate-200 bg-slate-50 space-y-3">
                ...
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <button
                    ...
                    className="w-full py-3 rounded-xl font-black text-sm shadow-lg transition flex items-center justify-center space-x-1.5 bg-amber-500 hover:bg-amber-400 active:bg-amber-600 text-slate-950 active:scale-[0.98]"
                  >
                    <CreditCard className="w-4 h-4 text-slate-950" />
                    <span>COBRAR</span>
                  </button>
