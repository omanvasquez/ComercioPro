            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
              <div>
                ...
                <p className="text-[11px] text-emerald-700 mt-0.5">
                  Presiona el botón para instalar ComercioPro inmediatamente en tu pantalla.
                </p>
              </div>
              <button
            ...
            <div className="space-y-3">
              <div className="p-3 rounded-2xl bg-indigo-50/70 border border-indigo-100">
                ...
                <p className="text-[11px] text-indigo-800 mt-1 leading-relaxed">
                  Al instalar en tu computadora (Windows, Mac o Linux), ComercioPro se abre en su propia ventana sin barra de direcciones ni pestañas del navegador, permitiendo atender a los clientes con máxima velocidad.
                </p>
              </div>
              ...
              <div className="space-y-2.5">
                ...
                <div className="flex items-start space-x-3 p-2.5 rounded-xl bg-slate-50 border border-slate-200">
                  ...
                  <div>
                    ...
                    <span className="text-slate-500">
                      Haz clic en los 3 puntos arriba a la derecha de Chrome &gt; <strong>Guardar y compartir</strong> &gt; <strong>Instalar ComercioPro...</strong>
                    </span>
                  </div>
                </div>
            ...
            <div className="space-y-3">
              <div className="p-3 rounded-2xl bg-emerald-50/70 border border-emerald-100">
                ...
                <p className="text-[11px] text-emerald-800 mt-1 leading-relaxed">
                  Gracias a los nuevos iconos de alta resolución y el Service Worker activo, tu teléfono reconocerá ComercioPro como una aplicación completa (no un simple acceso directo), funcionando en pantalla completa y con caché offline.
                </p>
              </div>
              ...
              <div className="space-y-2.5">
                ...
                <div className="flex items-start space-x-3 p-2.5 rounded-xl bg-slate-50 border border-slate-200">
                  ...
                  <div>
                    ...
                    <span className="text-slate-500">
                      Toca <strong>Instalar</strong>. El icono verde de ComercioPro aparecerá en tu lista de aplicaciones y pantalla de inicio como una App instalada.
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-2.5">
                ...
                <div className="flex items-start space-x-3 p-2.5 rounded-xl bg-slate-50 border border-slate-200">
                  ...
                  <div>
                    ...
                    <span className="text-slate-500">
                      En la esquina superior derecha pulsa <strong>Agregar</strong>. ComercioPro se abrirá como app nativa a pantalla completa.
                    </span>
                  </div>
                </div>
              </div>
