        ...
        <div className="flex items-center space-x-3">
          ...
          <div>
            <div className="flex items-center space-x-2">
              <span className="font-black text-lg tracking-tight text-white">ComercioPro</span>
        ...
        <div className="flex items-center space-x-2 sm:space-x-3">
          ...
          {!isInstalled && onOpenInstall && (
            <button
              ...
              className="flex items-center space-x-1.5 bg-amber-500 hover:bg-amber-400 text-slate-950 font-black px-2.5 sm:px-3 py-1.5 rounded-xl text-xs shadow-md shadow-amber-500/20 transition"
              title="Instalar ComercioPro en tu PC o Teléfono"
            >
          ...
          <div className="bg-white rounded-2xl p-5 max-w-sm w-full text-slate-800 shadow-2xl border border-slate-100 space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full px-3.5 py-2.5 rounded-xl border border-slate-300 text-lg font-bold text-slate-900 focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
            </div>
            ...
            <div className="grid grid-cols-2 gap-2 pt-2">
              ...
              <button
                ...
                className="py-2.5 px-3 rounded-xl bg-blue-600 text-white text-xs font-bold hover:bg-blue-700 transition flex items-center justify-center space-x-1"
              >
