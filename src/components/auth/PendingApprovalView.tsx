      ...
      <div className="max-w-md w-full bg-slate-900 border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-2xl space-y-6 text-center">
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs text-slate-400 leading-relaxed max-w-xs mx-auto">
            Hemos registrado los datos de tu comercio en ComercioPro. Para comenzar a operar, tu cuenta debe ser autorizada por el administrador.
          </p>
        </div>
