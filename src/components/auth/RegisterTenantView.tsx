        ...
        <form onSubmit={handleSubmit} className="space-y-4 text-xs">
          ...
          <div className="space-y-1.5">
            ...
            <input
              type="text"
              required
              placeholder="Ej. Comercial Don Pedro, Ferretería San José..."
              value={businessName}
              onChange={(e) => setBusinessName(e.target.value)}
              className="w-full px-4 py-3 rounded-xl bg-slate-800/80 border border-slate-700 text-sm font-semibold text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
          </div>
          ...
          <div className="space-y-1.5">
            <label className="font-bold text-slate-300 flex items-center space-x-1.5">
              ...
              <span>Teléfono WhatsApp del Negocio *</span>
            </label>
            <input
              type="tel"
              required
          ...
          <button
            ...
            className="w-full py-3.5 rounded-xl bg-amber-500 hover:bg-amber-400 active:bg-amber-600 text-slate-950 font-black text-sm transition shadow-lg shadow-amber-500/20 flex items-center justify-center space-x-2 active:scale-[0.98] disabled:opacity-50"
          >
