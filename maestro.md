# Maestro.md - Proyecto ComercioPro

## 1. Visión General del Proyecto
*   **Nombre de la App:** ComercioPro
*   **Modelo de Negocio:** SaaS / Software de Punto de Venta e Inventario para emprendimientos particulares y comercios de mostrador (papelerías, ferreterías, repuestos, comida rápida, tiendas de barrio).
*   **Cuenta / Propiedad:**
    *   Desarrollador / Propietario: Oman Vásquez (`omanjrvasquez@gmail.com`).
    *   Repositorio GitHub: Nuevo repositorio independiente para ComercioPro.
    *   Instancia Firebase: Proyecto independiente (`comerciopro-app`).
*   **Stack Tecnológico y Soporte Multiplataforma:** 
    ...
    *   **Catálogo Multirubro:** Gestión dinámica de categorías personalizables por cada comercio y unidades de medida físicas extendidas (unidad, kg, g, litro, metro, paquete, pieza, caja, par).

---

## 2. UI / UX (Interfaz y Experiencia)
*   **Identidad Visual:**
    *   *Color Primario (Estructura y Confianza):* Azul Noche / Deep Navy (`#0F172A`) y Azul Real (`#2563EB`) para barras, menús y solidez corporativa.
    *   *Color Secundario (Acción / Foco de Atención):* Ámbar / Oro Cálido (`#F59E0B`, `#D97706`) para botones principales de Cobro, acciones clave y badges.
    *   *Alertas / Alertas de deuda:* Rojo Ladrillo/Coral (Deudas, stock bajo, cuentas vencidas).
    *   *Fondo:* Gris Perla suave (`#F8FAFC`) para evitar fatiga visual en jornadas de 8-12 horas.
    *   *Icono App:* Icono estilizado tipo Google Play Store con squircle azul marino, iluminación ambient y emblema comercial en oro y blanco.
